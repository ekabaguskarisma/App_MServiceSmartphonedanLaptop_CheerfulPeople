...
public class FormRiwayatServis extends Form {
    ...
    private JPanel createTablePanel() {
        ...
        UIHelper.styleTable(tableRiwayat, TABLE_HEADER_BG, SIDEBAR_MAIN_COLOR);
    ...
    private JPanel createFooterPanel() {
        ...
        btnExport.addActionListener(e -> {
            ...
            UIHelper.exportToCSV(this, tableRiwayat, "Laporan_Riwayat_Servis");
        });
    ...
    private void bukaDetailNota() {
        try {
            ...
            if(row == -1) {
                UIHelper.tampilkanNotif(this, "Peringatan", "Pilih salah satu baris di tabel terlebih dahulu!", "warning");
                return;
            }
            ...
            ex.printStackTrace();
            UIHelper.tampilkanNotif(this, "Error UI", "Gagal membuka detail nota: " + ex.getMessage(), "error");
        }
    }
        ...
        javax.swing.SwingWorker<Void, Object[]> worker = new javax.swing.SwingWorker<>() {
            ...
            protected void done() {
                try {
                    ...
                    UIHelper.tampilkanNotif(FormRiwayatServis.this, "Database Error", "Gagal memuat tabel riwayat: " + e.getMessage(), "error");
                }
            }
        };
        worker.execute();
